...
import com.emergence.trackingapp.newTech.app.AppConfig;
...
public class ServiceGenerator {
    ...
    private static Retrofit.Builder builderFile = new Retrofit.Builder().baseUrl(API_Config.URL).addConverterFactory(GsonConverterFactory.create(gson));
